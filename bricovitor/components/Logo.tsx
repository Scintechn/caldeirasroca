...
export function Logo({
  ...
  const subColor = variant === "light" ? "text-accent-200" : "text-slate-500";
  return (
    <span className={cn("inline-flex items-center gap-2.5", className)}>
      <span
        aria-hidden="true"
        className="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-accent-500 text-brand-950 shadow-sm"
      >
