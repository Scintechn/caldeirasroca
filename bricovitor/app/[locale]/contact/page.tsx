    ...
    <Section variant="muted">
      <Container>
        <header className="max-w-3xl">
          ...
          <p className="mt-3 inline-flex items-start gap-2 rounded-lg bg-accent-50 px-3 py-2 text-sm text-accent-900 ring-1 ring-inset ring-accent-200">
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-[1.4fr_1fr]">
          ...
          <aside className="space-y-4">
            <div className="rounded-2xl bg-white p-6 ring-1 ring-slate-200 shadow-sm sm:p-7">
              ...
              <ul className="mt-5 space-y-3">
                ...
                <li>
                  <a
                    ...
                    className="flex w-full items-center gap-3 rounded-xl bg-accent-500 px-4 py-3 text-sm font-semibold text-brand-950 transition hover:bg-accent-600 sm:text-base"
                  >
                ...
                <li>
                  <a
                    ...
                    className="flex w-full items-center gap-3 rounded-xl bg-slate-100 px-4 py-3 text-sm font-semibold text-brand-900 ring-1 ring-slate-200 transition hover:bg-slate-200 sm:text-base"
                  >
            ...
            <div className="rounded-2xl bg-white p-6 ring-1 ring-slate-200 sm:p-7">
              <h2 className="font-display text-lg font-bold text-brand-900">
                {t.contact.altChannels.regionalLabel}
              </h2>
              <ul className="mt-4 grid grid-cols-1 gap-2 text-sm sm:grid-cols-2">
                {business.phone.regional.map((p) => (
                  <li key={p.href}>
                    <a
                      href={p.href}
                      className="flex items-center justify-between gap-2 rounded-lg bg-slate-50 px-3 py-2 text-slate-700 transition hover:bg-slate-100"
                    >
